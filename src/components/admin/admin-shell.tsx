      ...
      <div className="mb-6 flex items-center justify-between gap-2">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 flex-shrink-0 overflow-hidden rounded-lg bg-transparent [&_img]:!border-0 [&_img]:!shadow-none [&_img]:!outline-none [&_img]:!ring-0">
            <Image src="/logo-transparent.png" alt="Fuente Palmera" width={40} height={40} className="size-full rounded-full border-0 object-contain object-center outline-none ring-0 mix-blend-darken [&_img]:border-0 [&_img]:outline-none [&_img]:ring-0" unoptimized />
          </div>
