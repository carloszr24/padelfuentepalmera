    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="rounded-2xl border border-stone-200 bg-stone-50 px-5 py-4 shadow-sm">
          ...
          <p className="mt-1.5 text-2xl font-bold text-stone-900">
              ...
              {profiles?.length === 0 ? (
                ...
                profiles?.map((p) => (
                  <tr key={p.id} className="border-b border-stone-100 transition hover:bg-stone-50">
                    ...
                    <td className="px-4 py-3.5 align-middle text-right font-bold tabular-nums text-emerald-600">{Number(p.wallet_balance ?? 0).toFixed(2)} €</td>
                    <td className="px-4 py-3.5 align-middle">
