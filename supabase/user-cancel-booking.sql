-- ============================================================
-- Cancelar reserva por el usuario (con reembolso de señal)
-- Ejecuta en SQL Editor de Supabase (una sola vez).
-- ============================================================
...
BEGIN
  ...
  IF NOT v_booking.deposit_paid THEN
    -- Sin señal pagada: solo marcar cancelada
...
-- Permiso para que usuarios autenticados puedan llamar a la función
